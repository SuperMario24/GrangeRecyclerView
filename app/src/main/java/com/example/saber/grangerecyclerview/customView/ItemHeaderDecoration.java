package com.example.saber.grangerecyclerview.customView;
...
import com.example.saber.grangerecyclerview.MainActivity;
...
public class ItemHeaderDecoration extends RecyclerView.ItemDecoration {
    private List<DetailsBean> mDatas;
    ...
    public ItemHeaderDecoration(Context context, List<DetailsBean> datas) {
        super();
        this.mDatas = datas;
    ...
    public ItemHeaderDecoration setData(List<DetailsBean> mDatas) {
        this.mDatas = mDatas;
        return this;
    }
